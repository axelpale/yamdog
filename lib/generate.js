...
module.exports = (config) => {
  ...
  if (typeof config.earmark !== 'string' && !Array.isArray(config.earmark)) {
    // Note above: we allow empty string as earmark.
    throw new Error('Missing or invalid config.earmark')
  }
