...
module.exports = (blocks, names) => {
  ...
  //   ..   shortName, signature, aliases, paragraphs, isPrimary }
  ...
  blocks.forEach(block => {
    ...
    uniformBlocks.push({
      ...
      isPrimary: true // mark as the primary name among aliases
    })
    ...
    aliases.forEach(alias => {
      uniformBlocks.push({
        ...
        paragraphs: [], // empty paragraphs by default, decorators may fill.
        isPrimary: false // mark as a non-primary alias.
      })
    })
  })
